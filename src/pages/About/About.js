...
const About = () => {
  ...
  return (
    <>
        <Helmet><title>About Fanzlink</title></Helmet>
        <div className='about-section-wrapper'>
            <SubHeaders pageTitle="About Fanzlink" headerText="Find answers to commonly asked questions, and your submit requests to us and get a feedback in 24 hours" />
                ...
                <div className='about-us-section-wrapper'>
                    <div className='about-us-section-header'>
                        <div className='about-us-section-header-list'>
                            ...
                            <span>know more about your listings</span>
                        </div>
                    </div>
