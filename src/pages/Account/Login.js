...
import { userValidateUsername, userValidatePassword } from '../../components/validations/users/usersLogin'
import './account.css'
...
const Login = () => {
    ...
    const [isLoading, setIsLoading]                = useState({ username: false, password: false })
