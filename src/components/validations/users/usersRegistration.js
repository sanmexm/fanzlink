// const userEmails      = ["seun@email.com", "ayo@email.com", "jude@email.com", "ayo@email.com", "dele@email.com", "mark@email.com", "john@email.com", "ebiere@email.com", "ifeoma@email.com"] 
...
const userValidateSex = (postData) => {
    const errors = [];
    let isValid  = true;
    if (postData === '') {
        errors.push('');
